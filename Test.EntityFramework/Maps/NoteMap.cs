...
namespace Test.EntityFramework.Maps
{
    public class NoteMap : EntityTypeConfiguration<Note>
    {
        public NoteMap()
        {
            ...
            HasRequired(t => t.NoteType).WithMany(d => d.NoteTypes).HasForeignKey(t => t.NoteTypeId).WillCascadeOnDelete(false);
            HasRequired(t => t.NoteStatus).WithMany(d => d.NoteStatuses).HasForeignKey(t => t.NoteStatusId).WillCascadeOnDelete(false);
